...
### 方式一：OpenClaw 一键极速安装 (最酷的做法，推荐 🌟)
如果你和你的朋友使用的是 **OpenClaw (小龙虾)** 终端，完全不需要手动下载或创建文件夹！
你只需要把下面这句“咒语”直接发给你的小龙虾：

> **“帮我安装这个牛逼的开源选址 Skill，仓库地址是：`https://github.com/yyuchenBaii/ai_location_scout`，装好后告诉我。”**

小龙虾作为超强的智能终端，会自动在后台通过大模型能力，帮你克隆这个配置包并放到对应的 `.agents/skills` 目录去。装完之后，你只要和它聊起选址，它就会瞬间变身为**顶级地产合伙人**并开始召唤可视化研报！
